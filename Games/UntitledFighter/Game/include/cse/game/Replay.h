...
// The eight int32s are maxHealth, juggleMax, inputBufferFrames,
// hitstunDecayStep, hitstunDecayFloor, walkSpeedSub, moveCount and cancelCount.
// Written as a sum of the members rather than as a
...
static_assert(sizeof(cse::kernel::FighterData) ==
                  sizeof(cse::kernel::Box) + 8 * sizeof(std::int32_t) +
