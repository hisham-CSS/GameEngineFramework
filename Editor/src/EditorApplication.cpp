...
void EditorApplication::Initialize() 
{
    ...
    window = glfwCreateWindow(1280, 720, "Editor", NULL, NULL);
    if (!window) {
...
void EditorApplication::HandleShaderError(unsigned int shader)
{
    int  success;
    char infoLog[512];
...
void EditorApplication::ProcessInput(GLFWwindow* window)
{
